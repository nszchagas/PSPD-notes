/*
    ...
    Como compilar:
    $ nvcc -Xcompiler -fopenmp -I/usr/lib/x86_64-linux-gnu/openmpi/include -L/usr/lib/x86_64-linux-gnu/openmpi/lib -lmpi -lgomp jogodavidadp.cu -o cudaOMP
    Como rodar:
    $ OMP_NUM_THREADS=4 mpirun --host gpu1,gpu2,cm1,cm2 -np 4 cudaOMP
